...
module.exports = async function (context, req) {
    ...
    const reply = await axios({
        ...
        data: {
            "text": message,
            //"channel": reqJSON.channel_id //reply
            //"channel": process.env.slackWorkspaceChannelId //#guessla-game
            "channel": "C01PSQS84CT" //#bot-project
        },
        headers: {
            //"Authorization": process.env.slackWorkspaceBearerToken //nyk
            "Authorization": "Bearer xoxb-1805548730037-1833995318080-dU67ahdQCxyS3adcJ0T2sAYi" //test
